...
el('tab-tools').onclick();assert.equal(el('tools-view').hidden,false);assert.equal(el('group-view').hidden,true);
el('tab-plan').onclick();assert.equal(el('tools-view').hidden,true);
...
console.log('Verifierat: vybyte, verktygsflik, introduktion en gång, återspelning, hoppa över samt uppdaterad ordning och rubrik.');
